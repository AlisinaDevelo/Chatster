...
2. Install **Go 1.22+**, **Node 20.19+**, and (for `make lint`) [golangci-lint](https://golangci-lint.run/welcome/install/) on your PATH. CI runs the same linters if you skip local Go lint.
...
- **JavaScript / React**: ESLint flat config; run `npm run lint` in `frontend/`.
